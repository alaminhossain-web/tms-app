                ...
                <div class="col-md-8 col-lg-6">
                    <div class="hero-content">
                        <h6 class="hero-sub-title wow animate__animated animate__fadeInUp"
                            data-wow-duration="1s" data-wow-delay=".25s">Start To New Journey</h6>
                            ...
                            <form action="#">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="Search Your Course Today...">
...
<div class="category-area py-120">
    <div class="container">
        ...
        <div class="text-center">
            <a href="#" class="theme-btn mt-5"><span class="fad fa-sync-alt"></span> Explore All
                Category</a>
        </div>
    </div>
</div>
...
<div class="course-area bg py-120">
    <div class="container">
        ...
        <div class="row filter-box">
            <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat1 cat3 cat5">
                <div class="course-item">
                    ...
                    <div class="course-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/course/01.jpg"
                                alt></a>
                    </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat2 cat4 cat6">
                <div class="course-item">
                    ...
                    <div class="course-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/course/02.jpg"
                                alt></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat1 cat5 cat7">
                <div class="course-item">
                    <span class="course-tag course-tag-1">Beginer</span>
                    <div class="course-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/course/03.jpg"
                                alt></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat2 cat3 cat7 cat6">
                <div class="course-item">
                    <span class="course-tag course-tag-2">Advance</span>
                    <div class="course-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/course/04.jpg"
                                alt></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat2 cat4 cat5">
                <div class="course-item">
                    <span class="course-tag course-tag-1">Beginer</span>
                    <div class="course-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/course/05.jpg"
                                alt></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 filter-item cat4 cat7 cat6">
                <div class="course-item">
                    <span class="course-tag course-tag-2">Advance</span>
                    <div class="course-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/course/06.jpg"
                                alt></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
        ...
        <div class="text-center">
            <a href="#" class="theme-btn mt-5"><span class="fad fa-sync-alt"></span> Browse All
                Courses</a>
        </div>
    </div>
</div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="pricing-item">
                    ...
                    <div class="pricing-footer">
                        <a href="#" class="theme-btn">Get Started Now <i
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="instructor-item">
                    <div class="instructor-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/01.jpg"
                                alt="img"></a>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="instructor-item">
                    <div class="instructor-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/02.jpg"
                                alt="img"></a>
                    </div>
                    <div class="instructor-content">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="instructor-item">
                    <div class="instructor-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/03.jpg"
                                alt="img"></a>
                    </div>
                    <div class="instructor-content">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="instructor-item">
                    <div class="instructor-img">
                        <a href="#"><img src="{{ asset('/') }}front/assets/img/instructor/04.jpg"
                                alt="img"></a>
                    </div>
                    <div class="instructor-content">
                    ...
                    <div class="blog-item-info">
                        <div class="blog-item-meta">
                            <ul>
                                ...
                                <li><a href="#"><i class="far fa-calendar-alt"></i> May 11, 2023</a>
                                </li>
                            </ul>
                        </div>
                        <h4 class="blog-title">
...
<div class="cta-area  py-120">
    <div class="container">
        <div class="cta-wrapper">
            <div class="cta-arrow-shape"><img src="{{ asset('/') }}front/assets/img/shape/shape-arrow.svg"
                    alt></div>
            <div class="row align-items-center">
                <div class="col-lg-7">
