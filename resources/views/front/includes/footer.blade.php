                    ...
                    <div class="footer-widget-box about-us">
                        ...
                        <div>
                            <ul class="footer-contact">
                                ...
                                <li><a
                                        href="https://live.themewild.com/cdn-cgi/l/email-protection#ed84838b82ad88958c809d8188c38e8280"><i
                                            class="far fa-envelope"></i> Email:
                                        <span class="__cf_email__"
                                            data-cfemail="721b1c141d32170a131f021e175c111d1f">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                        <ul class="footer-social">
                            <li class="facebook-link"><a href="#"><i class="fab fa-facebook-f"></i></a>
                            </li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="footer-widget-box list">
                        ...
                        <div class="footer-app-download">
                            <h5>Download</h5>
                            <a href="#"> <img
                                    src="{{ asset('/') }}front/assets/img/download-icon/google-play.png" alt>
                            </a>
                            <a href="#"> <img
                                    src="{{ asset('/') }}front/assets/img/download-icon/app-store.png" alt>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <p class="copyright-text">
                        &copy; Copyright <span id="date"></span> <a href="#"> eduhub </a> All Rights
                        Reserved.
                    </p>
                </div>
                <div class="col-lg-6 align-self-center">
